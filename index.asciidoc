...
* Aprendido a usar o VirtualBox em linhas de comando
* Aprendido a usar o Git em linhas de comando
* Uma conta no GitHub e no Twitter

[.topic.source]
== Quando acabar a execução deste tutorial você terá ...
[.incremental]
* Publicado um repositório em sua conta no GitHub
** http://github.com/SEU_USUARIO/tutorial-git-github-executado
* Publicado slides escritos com Asciidoctor e DZSlides no GitHub Pages
