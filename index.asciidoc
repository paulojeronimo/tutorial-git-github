...
* _Incentivo: 50% de desconto na assinatura do curso online_. Regras
** Siga-me e  _tweet_: Aprendendo #git e #github com o http://twitter.com/paulojeronimo[@paulojeronimo] no http://twitter.com/flisoldf[@flisoldf]
...
----
* Utilize o Git para fazer o clone do projeto no GitHub
[source,bash]
----
$ git clone http://github.com/paulojeronimo/tutorial-git-github
----
